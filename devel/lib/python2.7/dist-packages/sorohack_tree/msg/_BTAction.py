...
"""autogenerated by genpy from sorohack_tree/BTAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import sorohack_tree.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class BTAction(genpy.Message):
  _md5sum = "51595fa6812c33085bb1d5eca2fd9d7a"
  _type = "sorohack_tree/BTAction"
...
"""
  ...
  _slot_types = ['sorohack_tree/BTActionGoal','sorohack_tree/BTActionResult','sorohack_tree/BTActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = sorohack_tree.msg.BTActionGoal()
      if self.action_result is None:
        self.action_result = sorohack_tree.msg.BTActionResult()
      if self.action_feedback is None:
        self.action_feedback = sorohack_tree.msg.BTActionFeedback()
    else:
      self.action_goal = sorohack_tree.msg.BTActionGoal()
      self.action_result = sorohack_tree.msg.BTActionResult()
      self.action_feedback = sorohack_tree.msg.BTActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.bt_action_goal
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_result.result.bt_status
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_feedback.feedback.bt_status
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.bt_action_goal = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.bt_action_goal = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_result.result.bt_status = str[start:end].decode('utf-8')
      else:
        self.action_result.result.bt_status = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.bt_status = str[start:end].decode('utf-8')
      else:
        self.action_feedback.feedback.bt_status = str[start:end]
      return self
