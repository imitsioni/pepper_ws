...
"""autogenerated by genpy from sorohack_tree/BTActionResult.msg. Do not edit."""
import sys
...
class BTActionResult(genpy.Message):
  _md5sum = "f563e3b17ff416e958336d56dda4be5a"
  _type = "sorohack_tree/BTActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sorohack_tree/BTResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = sorohack_tree.msg.BTResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = sorohack_tree.msg.BTResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.bt_status = str[start:end].decode('utf-8')
      else:
        self.result.bt_status = str[start:end]
      return self
