...
"""autogenerated by genpy from sorohack_tree/BTActionFeedback.msg. Do not edit."""
import sys
...
class BTActionFeedback(genpy.Message):
  _md5sum = "6a9f202ff0697107a59ad9e1d60077e9"
  _type = "sorohack_tree/BTActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sorohack_tree/BTFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = sorohack_tree.msg.BTFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = sorohack_tree.msg.BTFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.bt_status = str[start:end].decode('utf-8')
      else:
        self.feedback.bt_status = str[start:end]
      return self
